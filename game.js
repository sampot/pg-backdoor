...
export const CONFIG = {"title":"後門任務","genre":"沉浸式劫案","visual":"heist","accent":"#ff6b5f","actions":{"sneak":"通風管潛入","talk":"偽造訪客證","fight":"突破保全","hack":"入侵門禁","commit":"執行方案"},"help":"同一座資料堡壘有四條完整路線。準備潛行、話術、戰鬥或駭客資源，再執行專屬終局。","test":["hack","hack","hack","hack","commit"],"id":"pg-backdoor"};
